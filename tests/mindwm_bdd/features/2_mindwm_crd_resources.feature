...
Feature: MindWM Custom kubernetes resources
  ...
  #   Then the following cluster resources of type "disposablerequests.http.crossplane.io/v1alpha2" has a status "Available" equal "True"
  #     | resource name                 |
  #     | context-cyan-tab              |
  #     | user-bob-host-workstation-tab | 
  #     | user-bob-tab                  |
